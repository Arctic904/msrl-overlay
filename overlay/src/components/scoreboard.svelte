<script>
  import { data } from "../scripts/socket.js"
  ...
  <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="929.22" height="114.11" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 929.22 114.11" style="position: absolute; top:0px; left: 500px">
    ...
    <g id="Layer_2-2" data-name="Layer 2">
      <g id="Scoreboard">
        ...
        <text id="best-of" transform="translate(413.41 22.92)" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 19px; letter-spacing: -.01em;">Best Of 7</text>
        <text id="game" transform="translate(426.36 106.92)" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 19px; letter-spacing: -.01em;">Game 3</text>
        ...
        <g id="orng">
          <g id="orng-ticks">
            <polygon id="orng-tick-1" points="349.71 109.11 369.71 109.11 364.06 90.02 344.06 90.02 349.71 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="orng-tick-2" points="318.23 109.11 338.23 109.11 332.57 90.02 312.57 90.02 318.23 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="orng-tick-3" points="286.75 109.11 306.75 109.11 301.09 90.02 281.09 90.02 286.75 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="orng-tick-4" points="255.26 109.11 275.26 109.11 269.61 90.02 249.61 90.02 255.26 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
          </g>
          <text id="orng-score" transform="translate(25.7 72.31)" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 35px; letter-spacing: -.01em;">{$data?.teams[1].score}</text>
          <text id="orng-name" transform="translate(352.2 60.31)" dominant-baseline="middle" text-anchor="end" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 35px; letter-spacing: -.01em;">{$data?.teams[1].name}</text>
        </g>
        <g id="blue">
          <g id="blue-ticks">
            <polygon id="blue-tick-1" points="579.61 109.11 559.61 109.11 565.26 90.02 585.26 90.02 579.61 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="blue-tick-2" points="611.09 109.11 591.09 109.11 596.75 90.02 616.75 90.02 611.09 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="blue-tick-3" points="642.57 109.11 622.57 109.11 628.23 90.02 648.23 90.02 642.57 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
            <polygon id="blue-tick-4" points="674.06 109.11 654.06 109.11 659.71 90.02 679.71 90.02 674.06 109.11" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>
          </g>
          <text id="blue-score" transform="translate(879.34 72.31)" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 35px; letter-spacing: -.01em;">{$data?.teams[0].score}</text>
          <text id="blue-name" transform="translate(574.84 60.31)" dominant-baseline="middle" style="fill: #fff; font-family: IntegralCF-DemiBold, &apos;Integral CF&apos;; font-size: 35px; letter-spacing: -.01em;">{$data?.teams[0].name}</text>
        </g>
      </g>
    </g>
  </svg>
